  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.captcha.toLowerCase() !== captchaCode.toLowerCase()) {
      Swal.fire({
        ...
        text: 'The captcha code you entered is incorrect.',
      })
      generateCaptcha();
      return
    }
    ...
    try {
      ...
      if (data.success) {
        Swal.fire({
          icon: 'success',
          title: 'Success!',
          text: 'Retailer registration submitted successfully!',
        })
    ...
    <div className="min-h-screen bg-[#95c3f4] pt-20 md:pt-24 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row  overflow-hidden">
          ...
          <div className="w-full md:w-1/2 bg-[#95c3f4] flex flex-col items-center justify-center p-4 md:p-12 relative">
            <div className="w-full max-w-xl bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-8 flex flex-col items-center border border-white/20">
              <div className="text-center mb-6">
                <div className="flex items-center justify-center mb-2">
                  <div className="w-30 h-18 rounded-xl overflow-hidden flex-shrink-0 mb-6">
                    <img
                      src="/seqpaylogo.png"
                      alt="SeqPay Logo"
          ...
          {/* Right Column - Form */}
          <div className="w-full md:w-1/2 p-4 md:px-8 md:py-6 flex flex-col items-center justify-center ">
            <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 overflow-hidden flex flex-col">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-4">
                      <div className="flex items-center justify-center bg-gray-100 rounded-md px-3 py-1.5 select-none">
                        <span className="text-xl font-serif italic tracking-widest text-[#1e3a8a] flex gap-1">
                          {captchaCode.split('').map((char, i) => (
                            <span key={i} style={{ transform: `rotate(${Math.random() * 20 - 10}deg)` }}>{char}</span>
                          ))}
                        </span>
                        <button
                          type="button"
                    ...
                    <div className="flex items-start gap-3 py-0.5">
                      <input
                        type="checkbox"
                        id="agree"
                        className="mt-1 w-3.5 h-3.5 rounded border-gray-300 text-[#1e3a8a] focus:ring-[#1e3a8a] cursor-pointer"
